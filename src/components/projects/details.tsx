    ...
    <div className="min-h-screen">
      ...
      <div className="relative container mx-auto md:rounded-xl h-full md:h-[600px] overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url(${process.env.NEXT_PUBLIC_IMAGEKIT_URL}${project.heroImage})`,
          }}
        />
        <SafeImage
          src={project.heroImage || ""}
          alt={t("heroAlt", { title: project.title })}
          width={2266}
          height={675}
          sizes="100vw"
          priority
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="prose prose-lg max-w-none">
              <h2 className="text-3xl font-bold mb-2 md:mb-6">
                {t("projectOverview")}
              </h2>
          ...
          <div className="space-y-4">
            ...
            <Card className="p-6 shadow-2xl border-l-4 border-l-primary rounded-l-none">
              <h3 className="font-bold text-xl">{t("servicesProvided")}</h3>
